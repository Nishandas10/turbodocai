...
export default function Home() {
  ...
  <section className="relative mt-20 py-20 md:py-28 overflow-hidden">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-white mb-6">
         One App to Humanize AI Content, Summarize & Write notes📚 <span className="text-blue-600">Study 10x faster🚀</span>
        </h1>
         <p className="text-base md:text-xl text-gray-300 mb-10 max-w-3xl mx-auto">
         Upload anything PDF, video, lecture or website.. — get instant notes, Humanize essays, quizzes, flashcards and an AI tutor you can chat with.
        </p>
