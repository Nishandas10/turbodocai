...
echo ""
echo "Next steps:"
echo "1. Ensure OPENAI_API_KEY is set in your Functions environment"
echo "2. Optionally set OPENAI_VECTOR_STORE_ID if using a pre-created store; otherwise the app manages uploads per document"
